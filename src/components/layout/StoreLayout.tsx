...
export function StoreLayout({
      ...
      try {
        ...
        if (filtered.length > 0) {
          ...
          if (
            ...
            CURRENCIES[store.defaultCurrency as CurrencyCode]
          ) {
  ...
  if (isLoading) {
    return (
      <div className="min-h-[100dvh] w-full max-w-6xl mx-auto bg-white flex items-center justify-center">
  ...
  if (isError) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-white max-w-6xl mx-auto border-x">
  ...
  const navbarTextColor =
    isColored || isTransparent || isDark ? "#ffffff" : "#111827";
  const navbarBg = isColored
    ? primaryColor
    : isTransparent
      ? "transparent"
      : isDark
  ...
  return (
    <StoreUIContext.Provider value={{ darkMode, toggleDarkMode }}>
      <ThemeContext.Provider value={theme}>
        <div
          dir={isRTL ? "rtl" : "ltr"}
          className="min-h-[100dvh] w-full max-w-6xl mx-auto flex flex-col relative shadow-2xl overflow-hidden border-x md:shadow-none"
          style={{
            background: dm.bg,
        ...
        >
          ...
          {theme.announcementBar && announcementVisible && (
            <div
              ...
              style={{
                ...
                color: theme.announcementBarText || "#fff",
              }}
            >
          ...
          <header
            ...
            style={{
              ...
              boxShadow:
                isWhite && !isDark ? "0 1px 20px rgba(0,0,0,0.05)" : "none",
            ...
            >
              {availableCurrencies.length > 1 && (
                <div className="relative" ref={currencyRef}>
                  ...
                  {currencyOpen && (
                    <div
                      className={`absolute top-full mt-2 bg-white border border-gray-100 shadow-2xl rounded-2xl overflow-hidden z-[60] min-w-[150px] ${isRTL ? "left-0" : "right-0"}`}
                    >
              ...
              <button
                ...
                style={{
                  background:
                    isWhite && !isDark ? "#f3f4f6" : "rgba(255,255,255,0.18)",
                  color: navbarTextColor,
                }}
              >
                {language === "en" ? "عربي" : "EN"}
              ...
              >
                {[
                  ...
                  },
                  {
                    href: "/store/cart",
                    icon: ShoppingBag,
                    active: location.startsWith("/store/cart"),
          ...
          {(theme.instagram || theme.tiktok || theme.footerText) && (
            <div
              className="px-5 py-4 flex flex-col items-center gap-2 border-t"
