...
export default function Checkout() {
  ...
  if (success) {
    return (
      <StoreLayout>
        <div
          className="flex flex-col items-center justify-center min-h-[70vh] p-8 text-center gap-7"
          dir={isRTL ? "rtl" : "ltr"}
        >
          <motion.div
            initial={{ scale: 0 }}
          ...
          >
            ...
            {createdOrderNumber && (
              <p className="inline-flex items-center px-4 py-2 rounded-full bg-gray-50 border border-gray-100 text-sm font-black text-gray-700">
  ...
  const inputCls =
    "w-full px-4 py-3.5 text-sm bg-gray-50 border border-gray-100 rounded-2xl outline-none transition-all font-medium text-gray-800 placeholder:text-gray-400";
        ...
        <form onSubmit={handleSubmit} className="px-5 pt-5 space-y-4">
          ...
          <div
            ...
            style={{
              ...
              border:
                shippingRate === 0 ? "1px solid #bbf7d0" : "1px solid #fbd38d",
            }}
          >
            <Truck
              className="w-5 h-5 shrink-0"
              style={{ color: shippingRate === 0 ? "#16a34a" : "#dd6b20" }}
            />
            <div>
              <p
                className="text-sm font-bold"
                style={{ color: shippingRate === 0 ? "#166534" : "#9c4221" }}
              >
                {shippingRate === 0
                  ? "شحن مجاني لجميع المناطق 🎉"
                  : `تكلفة الشحن الثابتة: ${format(shippingRate)}`}
              </p>
              <p
                ...
                <div key={idx} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      ...
                      {item.selectedSize && (
                        <span className="text-[10px] bg-gray-100 px-1.5 py-0.5 rounded-lg text-gray-500 font-bold">
                          {item.selectedSize}
                        </span>
                      )}
                      {item.selectedColor && (
