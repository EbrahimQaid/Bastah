        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Input
              ...
              className="mt-1.5 h-11 bg-slate-950 border-slate-800 text-white placeholder-slate-600 focus:border-[#E8232A] focus:ring-[#E8232A]"
              value={form.email}
          ...
          <div>
            <div className="flex justify-between items-center">
              ...
              <button
                type="button"
                onClick={() =>
                  toast({ title: "تواصل معنا لاستعادة الوصول إلى حسابك" })
                }
                className="text-xs text-[#ff6b6b] hover:text-[#E8232A] transition-colors"
              >
                نسيت كلمة المرور؟
              </button>
            </div>
            <div className="relative mt-1.5">
              <Input
                ...
                required
                placeholder="••••••••"
                className="h-11 pl-10 bg-slate-950 border-slate-800 text-white placeholder-slate-600 focus:border-[#E8232A] focus:ring-[#E8232A]"
                value={form.password}
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full h-12 text-base font-semibold mt-6 text-white bg-[#E8232A] hover:bg-[#d01f25] transition-all border-none shadow-lg shadow-[#E8232A]/25"
          >
            {loading ? (
              "جارٍ الدخول..."
            ) : (
              <span className="flex items-center gap-2">
                دخول لوحة التحكم <ArrowRight size={18} />
              </span>
            )}
          </Button>
          ...
          <p className="text-center text-sm text-slate-400 mt-6">
            ...
            <button
              ...
              className="text-[#E8232A] font-semibold hover:underline"
            >
              أنشئ متجرك مجاناً
            </button>
          </p>
